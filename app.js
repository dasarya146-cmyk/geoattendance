...
function initCyberpunkFX() {
  // Spark Ripple Effect on Buttons
  document.querySelectorAll('.btn').forEach(btn => {
    btn.addEventListener('click', function(e) {
      ...
      // Scale ripple appropriately to cover button
  ...
  // Init tsParticles for floating micro-particles
  if (window.tsParticles) {
    window.tsParticles.load("tsparticles", {
      fpsLimit: 60,
      particles: {
        number: { value: 60, density: { enable: true, value_area: 800 } },
        color: { value: ["#00ff88", "#00f0ff", "#ffaa00"] },
        shape: { type: "circle" },
        opacity: {
          value: 0.6,
          random: true,
